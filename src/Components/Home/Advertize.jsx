...
const Advertize = () => {
  return (
    <div className="mx-w-[1240px] mx-auto md:mt-20 mt-10 mb-10 md:mb-20">
      ...
      >
        <SwiperSlide>
          <img className="w-full h-[190px]" src={banner1} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-[190px]" src={banner2} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-[190px]" src={banner4} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-[190px]" src={banner5} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-[190px]" src={banner6} alt="" />
        </SwiperSlide>
      </Swiper>
    </div>
  );
